...
(function () {
    ...
    var OnePageNav = function () {
        var navToggler = $('.farhanshahriyar-js-nav-toggle');
        $(".smoothscroll[href^='#'], #farhanshahriyar-navbar ul li a[href^='#']").on('click', function (e) {
            e.preventDefault();
            var hash = this.hash;
            $('html, body').animate({
        ...
        $("#farhanshahriyar-navbar ul li a[href^='#']").on('click', function (e) {
    ...
    $(window).scroll(function () {
        var $this = $(this)
            , st = $this.scrollTop()
            , navbar = $('.farhanshahriyar-header')
            , logo = $(".farhanshahriyar-header .logo> img");
        if (st > 150) {
    ...
    $('.farhanshahriyar-js-nav-toggle').on('click', function (e) {
        var $this = $(this);
        e.preventDefault();
        if ($('body').hasClass('menu-open')) {
            $this.removeClass('active');
            $('.farhanshahriyar-menu .farhanshahriyar-menu-inner > ul > li').each(function (i) {
                var that = $(this);
                setTimeout(function () {
            ...
            setTimeout(function () {
                $('.farhanshahriyar-menu').removeClass('farhanshahriyar-menu-show');
            }, 800);
            $('body').removeClass('menu-open');
        }
        else {
            $('.farhanshahriyar-menu').addClass('farhanshahriyar-menu-show');
    ...
    $('.farhanshahriyar-menu .dropdown').hover(function () {
        var $this = $(this);
        $this.addClass('show');
